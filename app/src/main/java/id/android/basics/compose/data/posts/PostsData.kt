...
import id.android.basics.compose.model.Markup
import id.android.basics.compose.model.MarkupType
import id.android.basics.compose.model.Metadata
import id.android.basics.compose.model.Paragraph
import id.android.basics.compose.model.ParagraphType
import id.android.basics.compose.model.Post
import id.android.basics.compose.model.PostAuthor
import id.android.basics.compose.model.Publication
...
val paragraphsPost1 = listOf(
  ...
  Paragraph(
    ...
    listOf(Markup(MarkupType.Link, 54, 79, "https://codelabs.developers.google.com/codelabs/on-demand-dynamic-delivery/index.html"))
  ),
  Paragraph(
    ParagraphType.Header,
    "Resources"
  ...
  Paragraph(
    ...
    listOf(Markup(MarkupType.Link, 0, 47, "https://www.youtube.com/watch?v=ihF-PwDfRZ4&list=PLWz5rJ2EKKc9FfSQIRXEWyWpHD6TtwxMM&index=32&t=0s"))
  ),
  Paragraph(
    ParagraphType.Bullet,
    "On Demand module codelab",
    listOf(Markup(MarkupType.Link, 0, 24, "https://codelabs.developers.google.com/codelabs/on-demand-dynamic-delivery/index.html"))
  ),
  Paragraph(
    ParagraphType.Bullet,
    "Patchwork Plaid — A modularization story",
    listOf(Markup(MarkupType.Link, 0, 40, "https://medium.com/androiddevelopers/a-patchwork-plaid-monolith-to-modularized-app-60235d9f212e"))
  )
)
...
val paragraphsPost2 = listOf(
  Paragraph(
    ...
    listOf(Markup(MarkupType.Link, 0, 6, "https://dagger.dev/"))
  ),
  Paragraph(
    ParagraphType.Text,
  ...
  Paragraph(
    ...
    listOf(Markup(MarkupType.Link, 58, 70, "https://github.com/google/dagger/issues/900"))
  ),
  Paragraph(
    ParagraphType.Header,
  ...
  Paragraph(
    ...
    listOf(
      Markup(MarkupType.Link, 99, 104, "https://github.com/google/dagger/releases/tag/dagger-2.18"),
      Markup(MarkupType.Link, 143, 148, "https://github.com/google/dagger/releases/tag/dagger-2.24"),
  ...
  Paragraph(
    ...
    listOf(
      Markup(MarkupType.Link, 92, 97, "https://github.com/google/dagger/releases/tag/dagger-2.18"),
      Markup(MarkupType.Link, 165, 170, "https://github.com/google/dagger/releases/tag/dagger-2.23")
    )
  ),
  Paragraph(
    ParagraphType.Text,
  ...
  Paragraph(
    ...
    listOf(
      ...
      Markup(MarkupType.Link, 268, 285, "http://frogermcs.github.io/dependency-injection-with-dagger-2-custom-scopes/"),
  ...
  Paragraph(
    ...
    listOf(
      ...
      Markup(MarkupType.Link, 132, 146, "https://kotlinlang.org/docs/reference/java-to-kotlin-interop.html#variant-generics")
    )
  ),
  Paragraph(
    ParagraphType.Text,
    ...
    listOf(
      ...
      Markup(MarkupType.Link, 66, 75, "https://en.wikipedia.org/wiki/Class_invariant"),
      Markup(MarkupType.Link, 96, 116, "https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.jvm/-jvm-suppress-wildcards/index.html")
    )
  ),
  Paragraph(
    ParagraphType.Text,
    "This is a common issue when you inject collections using Dagger’s multibinding feature, for example:",
    listOf(Markup(MarkupType.Link, 57, 86, "https://dagger.dev/multibindings.html"))
  ),
  Paragraph(
    ParagraphType.CodeBlock,
    """
...
val paragraphsPost3 = listOf(
  Paragraph(
    ...
    listOf(
      Markup(MarkupType.Link, 151, 172, "https://codelabs.developers.google.com/codelabs/java-to-kotlin/#0"),
      Markup(MarkupType.Link, 209, 216, "https://clmirror.storage.googleapis.com/codelabs/java-to-kotlin-zh/index.html#0"),
      Markup(MarkupType.Link, 226, 246, "https://codelabs.developers.google.com/codelabs/java-to-kotlin-pt-br/#0")
    )
  ),
  Paragraph(
    ParagraphType.Text,
    ...
    listOf(Markup(MarkupType.Link, 105, 124, "https://www.jetbrains.com/help/idea/converting-a-java-file-to-kotlin-file.html"))
  ),
  Paragraph(
    ParagraphType.Text,
  ...
  Paragraph(
    ...
    listOf(
      ...
      Markup(MarkupType.Link, 4, 25, "https://codelabs.developers.google.com/codelabs/java-to-kotlin/#0")
    )
  ),
  Paragraph(
    ParagraphType.Text,
    "Thanks to Walmyr Carvalho and Nelson Glauber for translating the codelab in Brazilian Portuguese!",
    listOf(Markup(MarkupType.Link, 21, 42, "https://codelabs.developers.google.com/codelabs/java-to-kotlin/#0"))
  ),
  Paragraph(
    ParagraphType.Text, "",
    listOf(Markup(MarkupType.Link, 76, 96, "https://codelabs.developers.google.com/codelabs/java-to-kotlin-pt-br/#0"))
  )
)
...
val paragraphsPost4 = listOf(
  ...
  Paragraph(
    ...
    listOf(
      Markup(MarkupType.Link, 61, 103, "https://issuetracker.google.com/issues/111961971"),
  ...
  Paragraph(
    ...
    listOf(
      ...
      Markup(MarkupType.Link, 28, 36, "https://issuetracker.google.com/issues/111961971#comment2"),
  ...
  Paragraph(
    ...
    listOf(
      Markup(MarkupType.Link, 66, 70, "https://github.com/googlesamples/android-architecture/pull/631"),
      Markup(MarkupType.Link, 75, 81, "https://github.com/googlesamples/android-architecture/pull/635"),
      Markup(MarkupType.Link, 128, 151, "https://github.com/googlesamples/android-architecture/pull/635/files#diff-7eb5d85ec3ea4e05ecddb7dc8ae20aa1R62")
    )
  )
)
...
val paragraphsPost5 = listOf(
  Paragraph(
    ...
    listOf(
      ...
      Markup(MarkupType.Link, 210, 221, "https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/index.html"),
      Markup(MarkupType.Link, 241, 250, "https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.sequences/index.html"),
  ...
  Paragraph(
    ...
    listOf(
      ...
      Markup(MarkupType.Link, 183, 199, "https://kotlinlang.org/docs/reference/inline-functions.html"),
      Markup(MarkupType.Link, 229, 232, "https://github.com/JetBrains/kotlin/blob/master/libraries/stdlib/common/src/generated/_Collections.kt#L1312"),
  ...
  Paragraph(
    ...
    listOf(
      ...
      Markup(MarkupType.Link, 222, 225, "https://github.com/JetBrains/kotlin/blob/master/libraries/stdlib/common/src/generated/_Sequences.kt#L860")
    )
  ),
  Paragraph(
    ParagraphType.CodeBlock,
  ...
  Paragraph(
    ...
    listOf(
      ...
      Markup(MarkupType.Link, 27, 32, "https://github.com/JetBrains/kotlin/blob/master/libraries/stdlib/common/src/generated/_Sequences.kt#L117")
    )
  ),
  Paragraph(
    ParagraphType.CodeBlock,
  ...
  Paragraph(
    ...
    listOf(
      ...
      Markup(MarkupType.Link, 193, 207, "https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/#functions")
    )
  ),
  Paragraph(
    ParagraphType.Header,
