package id.android.basics.compose.data.local

import id.android.basics.compose.R
import id.android.basics.compose.data.Account

/**
 * An static data store of [Account]s
 * This includes both [Account]s owned by the current user and all [Account]s of the current user's contacts
 */
object LocalAccountsDataProvider {
  ...
  /**
   * Get the contact of the current user with the given [Account.id]
   */
